...
class ExitBattleDialog extends StatelessWidget{
  const ExitBattleDialog({super.key, required this.title, required this.content, required this.yesAction, required this.yesText, required this.noAction, required this.noText});
